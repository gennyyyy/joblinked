...
export default function EmployerRegister() {
  ...
  const { registerEmployer, dbReady } = useAuth();
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      toast.success('Company registered! Please sign in with your credentials.');
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-8 rounded-2xl shadow-2xl relative overflow-hidden">
          ...
          <p className="text-center text-slate-500 text-sm font-medium mt-6">
            ...
            <Link to="/employers/login" className="text-blue-600 hover:underline">
              Sign in
            </Link>
          </p>
        </div>
